...
/**
 *
 * @param teacherId Teach id
 * @returns {{createMetrics: createMetrics}} Object with function to create metrics
 */
function Metrics(teacherId) {
    ...
    /**
     * Get metrics of every class that a prof. has
     *
     * @returns {Promise} Promise containing the metrics result or the error
     */
    ...
    /**
     * Get metrics of a specific class that of a prof.
     *
     * @param _class Class
     * @returns {Promise} Promise containing the result of the metrics of the class or the error
     */
    ...
    /**
     * Get metrics of every student that a prof lecture
     *
     * @returns {Promise} Promise containing the metrics result or the error
     */
    ...
    /**
     * Get metrics of every lesson that a prof lectures
     *
     * @returns {Promise} Promise containing the metrics result or the error
     */
    ...
    /**
     * Get metrics of every presence of each student that a prof lecture
     *
     * @returns {Promise} Promise containing the metrics result or the error
     */
    ...
    /**
     * Get metrics of every evaluations of a student that a prof has lecture
     *
     * @returns {Promise} Promise containing the metrics result or the error
     */
    ...
    /**
     * Get metrics of every subject that a prof teaches
     *
     * @returns {Promise} Promise containing the metrics result or the error
     */
    ...
    /**
     * Creates a worksheet based on the metrics received
     *
     * @param metricsToCreate Metrics to export to a worksheet
     * @returns {Promise} Promise containing the worksheet result or the error
     */
    ...
    /**
     * Given a metric identification creates the respective metric associated
     *
     * @param metricId Metric identification
     * @returns {*} Result of the metrics
     */
    ...
    /**
     * Given a metric identification returns the respective metric name
     *
     * @param metricId Metric identification
    ...
    /**
     * Removes duplicated objects with a given key in an array
     *
     * @param keyFn Key to filter by
     * @param array Array to filter
     * @returns {Array.<T>|*} Array filtered without duplicated
     * @private
     */
